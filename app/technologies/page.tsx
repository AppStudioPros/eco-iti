...
export default function TechnologiesPage() {
  return (
    <>
      {/* ── Hero ── */}
      <section className="pt-32 pb-20 px-6 text-center" style={{ background: 'linear-gradient(135deg, #0A1A14 0%, #0D2E1E 100%)' }}>
      ...
      <section className="bg-white py-20 md:py-28 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p data-reveal="fade" data-delay="160" className="leading-relaxed mb-4" style={{ color: '#5A8070' }}>
            ...
            <p data-reveal="fade" data-delay="220" className="leading-relaxed mb-8" style={{ color: '#5A8070' }}>
      ...
      {/* ── H2O Recover ── */}
      <section style={{ backgroundColor: '#F3F7F5' }} className="py-20 md:py-28 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
