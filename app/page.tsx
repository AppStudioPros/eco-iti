        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Link href="/technologies/water-recovery-systems" data-reveal data-delay="100" className="group card-hover block rounded-2xl overflow-hidden bg-white" style={{ boxShadow: '0 2px 16px rgba(11,34,64,0.08)', border: '1px solid #E0EBF5' }}>
              ...
              <div className="p-8">
                <div className="mb-6 flex justify-center"><img src="/images/logos/ECO-Water-Recovery-Systems-Logo.jpg" alt="ECO Water Recovery Systems™" className="h-[78px] w-auto object-contain" /></div>
                ...
                <div className="flex items-center justify-center gap-2 text-sm font-semibold" style={{ color: '#1663AF' }}>
                  Explore ECO Water Recovery Systems™ <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
                </div>
              </div>
            </Link>
          </div>
